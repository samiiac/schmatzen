          ...
          {reservations.map((reservation) => (
            <div key={reservation._id} className="reservation-card">
              <div className="reservation-header">
                ...
                <span
                  className={`badge ${reservation.reservationStatus === "confirmed" ? "badge-success" : "badge-warning"}`}
                >
              ...
              <div className="reservation-details">
                <p>
                  <strong>Package:</strong> {reservation.serviceType}
                </p>
                <p>
                  <strong>Date:</strong>{" "}
                ...
                <p>
                  <strong>Location:</strong> {reservation.shootLocation}
                </p>
                <p>
                  <strong>Amount:</strong> ₹{reservation.totalAmount}
                </p>
              </div>
              <button
                onClick={() =>
